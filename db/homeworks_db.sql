...
CREATE TABLE tipo(
    ...
    tipo_created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
CREATE TABLE tarea(
    ...
    tarea_created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    tarea_updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    id_user INT,
